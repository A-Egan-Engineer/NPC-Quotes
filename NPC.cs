...
public static class NPC
{
    ...
    private static List<Entity> _entities = new List<Entity>()
    {
        ...
        new Entity("College Boy", "The snozzberries taste like snozzberries."),
        new Entity("Thorny", "Who wants a mustache ride?"),
        new Entity("Rabbit", "See if they've got any chocolate bananas, Foster?"),
        new Entity("Captain O'Hagan", "I'll believe that when my shit turns purple and smells like rainbow sherbert!"),
        new Entity("Foster", "Ahhh, Biker. I'm such an idiot."),
        new Entity("Farva", "License and registration... chicken fucker!"),
